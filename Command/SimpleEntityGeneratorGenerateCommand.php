...
namespace SimpleEntityGeneratorBundle\Command;
...
class SimpleEntityGeneratorGenerateCommand extends ContainerAwareCommand
{
    ...
    protected function processStructures(OutputInterface $output, ArrayCollection $classManagers, $onlySimulate = false)
    {
        foreach ($classManagers as $classManager) {
            /* @var $classManager \SimpleEntityGeneratorBundle\Lib\Items\ClassManager */
    ...
    /**
     * @return \SimpleEntityGeneratorBundle\Lib\FilesManager
     */
    ...
    /**
     * @return \SimpleEntityGeneratorBundle\Lib\StructureGenerator
     */
